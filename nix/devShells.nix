rec {
  shellHook-for = { package, pythoneda-base, python, nixpkgsRelease }: ''
    ...
    echo -e " \033[32m| '_ \| | | | __| '_ \ / _ \| '_ \ \033[34m/ _ \\\\\033[35m/ _\` |\033[36m/ _\` |\033[34mhttps://github.com/pythoneda-tenant-infrastructure/base\033[0m";
    echo -e " \033[32m| |_) | |_| | |_| | | | (_) | | | |\033[34m  __/\033[35m (_| |\033[36m (_| |\033[35mhttps://github.com/pythoneda-tenant/base\033[0m";
    ...
    echo;
    echo " Thank you for using pythoneda-tenant-infrastructure/base and for your appreciation of free software.";
    echo;
